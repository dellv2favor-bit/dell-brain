 ...
 * Bot Loop Breaker
 *
 * Built by Dell's auto-builder on 2026-03-23.
 *
 * WHY: Dell and other WhatsApp AI bots (like Josh's Cortana) get into
 * infinite reply loops — each bot thinks it's talking to a person and
 * keeps responding. This wastes API credits and floods the chat.
 *
 * WHAT: Detects rapid back-and-forth patterns with low text variation,
...
class BotLoopBreaker {
   ...
   * direction: 'in' (received) or 'out' (sent by Dell)
   */
...
if (require.main === module) {
  ...
  lb.track(jid, 'Hi there! I am Cortana.', 'in');
  ...
  console.log('shouldSkip "[Message from Cortana AI bot]":', lb.shouldSkip('[Message from Cortana AI bot]'));
  console.log('Muting...');
  lb.mute(jid, 1);
